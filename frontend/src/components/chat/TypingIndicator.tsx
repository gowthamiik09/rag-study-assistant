...
export default function TypingIndicator() {
  return (
    <div className="flex items-start gap-3 px-4 py-1 animate-fade-up">
      {/* AI avatar */}
      <div className="w-7 h-7 rounded-[9px] flex-shrink-0 flex items-center justify-center text-[10px] font-bold text-white"
